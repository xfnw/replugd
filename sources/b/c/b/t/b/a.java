...
final class a {
    ...
    public byte[] a() {
        ...
        int c2 = this.f1890a.c();
        int e2 = this.f1890a.e();
        for (int i = 0; i < c2; i++) {
            int[] iArr = f1889b[i];
            for (int i2 = 0; i2 < e2; i2++) {
                int i3 = iArr[i2];
                if (i3 >= 0 && this.f1890a.b(i2, i)) {
                    int i4 = i3 / 6;
