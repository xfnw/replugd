...
final class g {
    ...
    private final List<int[]> f1909a = new ArrayList();

    /* renamed from: b  reason: collision with root package name */
    private final List<String> f1910b = new ArrayList();
    ...
    public String a(String str) {
        ...
        for (int i2 = 0; i2 < size && parseInt >= (i = (iArr = this.f1909a.get(i2))[0]); i2++) {
            if (iArr.length != 1) {
                i = iArr[1];
            }
            if (parseInt <= i) {
