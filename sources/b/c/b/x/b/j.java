...
public final class j {
    ...
    private static final int[] f2054e = {31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017};
    ...
    public b.c.b.r.b a() {
        int c2 = c();
        b.c.b.r.b bVar = new b.c.b.r.b(c2);
        bVar.a(0, 0, 9, 9);
        int i = c2 - 8;
        bVar.a(i, 0, 8, 9);
        bVar.a(0, i, 9, 8);
        int length = this.f2056b.length;
        for (int i2 = 0; i2 < length; i2++) {
            int i3 = this.f2056b[i2] - 2;
            for (int i4 = 0; i4 < length; i4++) {
                if (!((i2 == 0 && (i4 == 0 || i4 == length - 1)) || (i2 == length - 1 && i4 == 0))) {
                    bVar.a(this.f2056b[i4] - 2, i3, 5, 5);
                }
            }
        }
        int i5 = c2 - 17;
    ...
    public b a(f fVar) {
        return this.f2057c[fVar.ordinal()];
    }
    ...
    public String toString() {
        return String.valueOf(this.f2055a);
    }
}
