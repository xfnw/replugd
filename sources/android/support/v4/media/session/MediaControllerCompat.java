...
public final class MediaControllerCompat {
    ...
    /* loaded from: classes.dex */
    private static class MediaControllerExtraData extends d.a {
            ...
            protected void onReceiveResult(int i, Bundle bundle) {
                ...
                if (mediaControllerImplApi21 != null && bundle != null) {
                    synchronized (mediaControllerImplApi21.mLock) {
                        mediaControllerImplApi21.mSessionToken.setExtraBinder(IMediaSession.Stub.asInterface(c.a(bundle, MediaSessionCompat.KEY_EXTRA_BINDER)));
    ...
    public static MediaControllerCompat getMediaController(Activity activity) {
        ...
        if (activity instanceof d) {
            MediaControllerExtraData mediaControllerExtraData = (MediaControllerExtraData) ((d) activity).a(MediaControllerExtraData.class);
    ...
    public static void setMediaController(Activity activity, MediaControllerCompat mediaControllerCompat) {
        if (activity instanceof d) {
            ((d) activity).a(new MediaControllerExtraData(mediaControllerCompat));
        }
        if (Build.VERSION.SDK_INT >= 21) {
            Object obj = null;
