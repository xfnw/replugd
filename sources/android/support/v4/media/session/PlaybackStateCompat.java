...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public Object getPlaybackState() {
        if (this.mStateObj == null && Build.VERSION.SDK_INT >= 21) {
            ...
            this.mStateObj = i >= 22 ? PlaybackStateCompatApi22.newInstance(i2, j, j2, f, j3, charSequence, j4, arrayList, this.mActiveItemId, this.mExtras) : PlaybackStateCompatApi21.newInstance(i2, j, j2, f, j3, charSequence, j4, arrayList, this.mActiveItemId);
        }
